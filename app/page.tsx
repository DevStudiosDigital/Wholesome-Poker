...
export default function Home() {
  return (
    <div>
      ...
      <div className="p-4 lg:p-6 2xl:p-10 flex flex-col lg:flex-row gap-4 justify-between bg-[#0f100f8f] rounded-[16px] 2xl:rounded-[24px] md:mb-[120px]">
        <div className="bg-card/60 flex flex-col md:flex-row px-6 lg:px-12 2xl:px-16 py-6 lg:py-6 2xl:py-8 gap-8 md:gap-12 lg:gap-20 2xl:gap-[100px] rounded-[16px] 2xl:rounded-[24px]">
          <div>
        ...
        <button className="bg-secondary flex items-center justify-center py-6 gap-2 text-black rounded-[16px] md:rounded-[20px] 2xl:rounded-[24px] px-0 lg:px-20 2xl:px-40 hover:opacity-90">
          <WalletBlackIcon className="w-8 h-8 lg:w-10 lg:h-10 2xl:w-12 2xl:h-12" />
          <span className="text-[24px] lg:text-[28px] 2xl:text-[40px] font-bold">
            Connect Wallet
          </span>
        </button>
      </div>
