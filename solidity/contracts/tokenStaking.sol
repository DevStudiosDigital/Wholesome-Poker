...
/// @title Wholesome Poker Token Staking
...
contract WholesomePokerTokenStaking is Ownable, ERC20, ReentrancyGuard {
     ...
     */
    function stake(uint256 amountUSDB, uint256 amountETH, uint256 stakedTokenId) external payable isContractState(ContractState.OPEN) nonReentrant {
        ...
        _mint(msg.sender, (amountETH + amountUSDB));
    }
     ...
     */
    function unstake(uint256 amountUSDB, uint256 amountETH) external isContractState(ContractState.OPEN) nonReentrant {
        ...
        _burn(msg.sender, amountETH + amountUSDB);
    }
    ...
    function claimYield(address recipient, uint256 amount) external onlyOwner nonReentrant {
